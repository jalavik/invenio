...
def find_personids_by_name(query_string, trust_is_operating=False):
    ...
    surname_score_clusters = create_surname_score_clusters(indexable_qstring_sur, author_to_names_mapping, surname_score_cache, strings_to_ids_mapping)

    sorted_authors = sort_authors(indexable_qstring, qstring_first_names, surname_score_clusters, author_to_names_mapping, strings_to_ids_mapping)
...
def sort_authors(indexable_string, query_names, surname_score_clusters, author_to_names_mapping, strings_to_ids_mapping):
    '''
