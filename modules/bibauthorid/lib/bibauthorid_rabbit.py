...
def rabbit(bibrecs=None, check_invalid_papers=False,
    ...
    for idx, rec in enumerate(bibrecs):
        ...
        bibauthorid_print(True, " - Deleted signatures: %s" % str(old_signatures))
        bibauthorid_print(True, " - Added signatures: %s" % str(new_signatures))
        bibauthorid_print(True, " - Matrix: %s" % str(matrix))
        ...
        bibauthorid_print(True, " - Best match: %s " % str(best_match))

        for new, old in best_match:
            bibauthorid_print(True, "  -  -  Moving signature: %s on %s to %s as %s" %
        ...
        bibauthorid_print(True, " - Not matched: %s" % str(not_matched))
