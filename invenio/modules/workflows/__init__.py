...
.. sidebar:: Approval action
    ...
    (JavaScript/HTML/templates) to display buttons and a Python back-end plugin to
    react on the chosen action.
...
To enable the JavaScript to be loaded via requireJS, you need to add the
JavaScript file to the `static/workflows/actions/init.js` file and initialize
it (if you use flightJS).
