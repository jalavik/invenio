...
`obj` (:py:class:`workflow.models.DbWorkflowObject`)
...
The former use the :py:class:`workflow.models.DbWorkflowObject` model API, and
...
:py:class:`workflow.models.DbWorkflowObject`
...
If you need to add some extra data to the :py:class:`workflow.models.DbWorkflowObject` that is
...
This information is used by the :py:class:`workflow.models.DbWorkflowObject` to store some additional
