...
def foreach(get_list_function=None, savename=None, cache_data=False, order="ASC"):
    ...
    _foreach.hide = 'Dont show in details page'
    return _foreach
...
def simple_for(inita, enda, incrementa, variable_name=None):
    ...
    _simple_for.hide = 'Dont show in details page'
    return _simple_for
...
end_for.hide = 'Dont show in details page'
...
def workflow_if(cond, neg=False):
    ...
    _workflow_if.hide = 'Dont show in details page'
    return _workflow_if
...
workflow_else.hide = 'Dont show in details page'
